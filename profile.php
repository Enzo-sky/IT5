...
<script>
  ...
  document.getElementById("votedStatus").innerText = voted ? "Yes" : "No";
  document.getElementById("votingStatus").innerText = votingOpen ? "🟢 Voting is Open" : "🔴 Voting is Closed";
  ...
  document.getElementById("editProfileBtn").addEventListener("click", () => {
    ...
    if(newID) {
      ...
      document.getElementById("studentID").innerText = newID;
    }
