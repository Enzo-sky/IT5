...
<body class="bg-gray-50">
        ...
        <main class="flex-1 overflow-y-auto">
            ...
            <div class="p-8">
                ...
                <div class="mb-6 flex gap-2">
                    <a href="?status=all" class="px-4 py-2 rounded-lg text-sm font-medium <?php echo $filter === 'all' ? 'bg-blue-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'; ?>">All</a>
                    ...
                    <a href="?status=archived" class="px-4 py-2 rounded-lg text-sm font-medium <?php echo $filter === 'archived' ? 'bg-indigo-600 text-white' : 'bg-white text-gray-600 hover:bg-gray-50'; ?>">Archived</a>
                </div>
    ...
    <!-- Modal for Create/Edit -->
        <div id="electionModal" class="<?php echo $edit_election ? 'fixed' : 'hidden'; ?> inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center" style="position: fixed; top: 0; left: 0; width: 100%; height: 100%; display: <?php echo $edit_election ? 'flex' : 'none'; ?>; align-items: center; justify-content: center;">        <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-screen overflow-y-auto">
