...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    switch ($_POST['action']) {
        case 'add_position':
            $stmt = $db->prepare("INSERT INTO positions (election_id, title, description, max_selections) 
                      VALUES (?, ?, ?, ?)");
            try {
                $stmt->execute([$election_id, $_POST['title'], $_POST['description'], $_POST['max_selections']]);
            ...
            <div class="p-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
                    ...
                    <form method="GET" class="flex gap-3">
                        <select name="election_id" onchange="this.form.submit()" class="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
